...
namespace Interface
{
    class Functions
    {
        ...
        public static void Connect()
        {
            ...
            connString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\SiiCoffee\Interface\Database\DBTTCN.mdf;Integrated Security=True;Connect Timeout=30";
        ...
        public static void Disconnect()
        {
            if (Conn.State == ConnectionState.Open)
            {
                ...
                Conn = null;
                //    MessageBox.Show("Bạn đã đóng kết nối!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        public static void FillComboSii(string sql, SiiControls.SiiComboBox cbo, string ma, string ten)
        {
            SqlDataAdapter Mydata = new SqlDataAdapter(sql, Functions.Conn);
            DataTable table = new DataTable();
            Mydata.Fill(table);
